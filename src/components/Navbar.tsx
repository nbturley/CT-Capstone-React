  ...
  return (
    <nav className="sticky top-0 flex items-center justify-between flex-wrap bg-black p-6">
        <div className="flex items-center flex-shrink-0 text-white mr-6">
            <Link to='/' className="font-semibold text-2xl tracking-tight">Car Maintenance</Link>
        </div>
        <div className="block">
        ...
        { isVisible ? (
            <div className='w-full block flex-grow items-center'>
                <div className="text-sm lg:flex-grow m-4">
                    ...
                    <button className='p-2 m-5 bg-black hover:bg-gray-500 border rounded-lg hover:border-gray-500 text-center'>
                        <div>
                            <Link to='/about' className='flex place-items-center lg:inline-block mt-0 text-white hover:bg-gray-500'>About</Link>
                        </div>
                    </button>
                    <button className='p-2 m-5 bg-black hover:bg-gray-500 border rounded-lg hover:border-gray-500 text-center'>
                        <div>
                            <Link to='/garage' className='flex place-items-center lg:inline-block mt-0 text-white hover:bg-gray-500'>Garage</Link>
                        </div>
                    </button>
                    <button className='p-2 m-5 bg-black hover:bg-gray-500 border rounded-lg hover:border-gray-500 text-center'>
                        <div>
                            <Link to='/service' className='flex place-items-center lg:inline-block mt-0 text-white hover:bg-gray-500'>Service</Link>
                        </div>
                    </button>
                    {
                        !auth.currentUser ?
